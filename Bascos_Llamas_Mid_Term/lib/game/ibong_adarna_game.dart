...
import 'package:flappy_bird_game/components/tree_group.dart';
import 'package:flappy_bird_game/game/configuration.dart';
import 'package:flutter/painting.dart';

class IbongAdarna extends FlameGame with TapDetector, HasCollisionDetection {
  IbongAdarna();

  late Bird bird;
  Timer interval = Timer(Config.treeInterval, repeat: true);
  bool isHit = false;
